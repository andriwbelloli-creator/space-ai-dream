...
export const catalog: ReadonlyArray<CatalogImage> = [
  // ---- hero ----
  { id: "hero-living-empty",     src: emptyLiving,     alt: "Sala de estar vazia",     section: "hero", room: "sala", kind: "empty",     pairId: "hero-living" },
  { id: "hero-living-decorated", src: decoratedLiving, alt: "Sala de estar decorada",  section: "hero", room: "sala", kind: "decorated", pairId: "hero-living", style: "moderno" },

  // ---- empty rooms carousel (all empties, no overlap with featured-ba/showcase) ----
  { id: "empty-bedroom",  src: emptyBedroom,  alt: "Quarto vazio",        section: "empty-carousel", room: "quarto",      kind: "empty" },
  { id: "empty-kitchen",  src: emptyKitchen,  alt: "Cozinha simples",     section: "empty-carousel", room: "cozinha",     kind: "empty" },
  { id: "empty-office",   src: emptyOffice,   alt: "Home office vazio",   section: "empty-carousel", room: "home-office", kind: "empty" },
  { id: "empty-studio",   src: emptyStudio,   alt: "Studio compacto",     section: "empty-carousel", room: "studio",      kind: "empty" },
  { id: "empty-bathroom", src: emptyBathroom, alt: "Banheiro vazio",      section: "empty-carousel", room: "banheiro",    kind: "empty" },
  { id: "empty-dining",   src: emptyDining,   alt: "Sala de jantar vazia",section: "empty-carousel", room: "jantar",      kind: "empty" },

  // ---- styles carousel ----
  { id: "style-japandi",    src: styleJapandi,    alt: "Estilo Japandi",       section: "style-carousel", kind: "style", style: "japandi" },
  { id: "style-scandi",     src: styleScandi,     alt: "Estilo Escandinavo",   section: "style-carousel", kind: "style", style: "escandinavo" },
  { id: "style-modern",     src: styleModern,     alt: "Estilo Contemporâneo", section: "style-carousel", kind: "style", style: "moderno" },
  { id: "style-industrial", src: styleIndustrial, alt: "Estilo Industrial",    section: "style-carousel", kind: "style", style: "industrial" },
  { id: "style-luxo",       src: styleLuxo,       alt: "Estilo Luxo discreto", section: "style-carousel", kind: "style", style: "luxo" },
  { id: "style-natural",    src: styleNatural,    alt: "Estilo Natural",       section: "style-carousel", kind: "style", style: "natural" },

  // ---- featured before/after (dedicated pair, NOT in carousel) ----
  { id: "ba-bathroom-empty",     src: emptyBathroomSuite,     alt: "Banheiro master vazio",    section: "featured-ba", room: "banheiro", kind: "empty",     pairId: "ba-bathroom" },
  { id: "ba-bathroom-decorated", src: decoratedBathroomSuite, alt: "Banheiro master decorado", section: "featured-ba", room: "banheiro", kind: "decorated", pairId: "ba-bathroom", style: "luxo" },

  // ---- result showcase (dedicated pair, NOT in carousel) ----
  { id: "show-kitchen-empty",     src: emptyKitchenIsland,     alt: "Cozinha com ilha vazia",    section: "showcase", room: "cozinha", kind: "empty",     pairId: "show-kitchen" },
  { id: "show-kitchen-decorated", src: decoratedKitchenIsland, alt: "Cozinha com ilha decorada", section: "showcase", room: "cozinha", kind: "decorated", pairId: "show-kitchen", style: "luxo" },

  // ---- inspiration gallery ----
  { id: "g-living-warm",  src: decoratedLivingWarm, alt: "Sala moderna decorada",            section: "gallery", room: "sala",        kind: "decorated", style: "moderno" },
  { id: "g-bedroom",      src: decoratedBedroom,    alt: "Quarto japandi sereno",            section: "gallery", room: "quarto",      kind: "decorated", style: "japandi" },
  { id: "g-loft",         src: galleryLoft,         alt: "Loft industrial integrado",        section: "gallery", room: "loft",        kind: "decorated", style: "industrial" },
  { id: "g-varanda",      src: galleryVaranda,      alt: "Varanda urbana ao pôr do sol",     section: "gallery", room: "varanda",     kind: "decorated", style: "natural" },
  { id: "g-dining",       src: decoratedDining,     alt: "Sala de jantar com lista pronta",  section: "gallery", room: "jantar",      kind: "decorated", style: "luxo" },
  { id: "g-floorplan",    src: floorplanApartment,  alt: "Planta baixa de apartamento",      section: "gallery", room: "planta",      kind: "plan" },
  { id: "g-moodboard",    src: moodboardPro,        alt: "Moodboard arquitetônico",          section: "gallery",                       kind: "moodboard" },
  { id: "g-office",       src: galleryOffice,       alt: "Home office natural",              section: "gallery", room: "home-office", kind: "decorated", style: "natural" },
  { id: "g-clinic",       src: galleryClinic,       alt: "Consultório acolhedor",            section: "gallery", room: "clinica",     kind: "decorated", style: "moderno" },

  // ---- ranking (community picks) ----
  { id: "rank-minimal-bedroom", src: rankMinimalBedroom, alt: "Quarto minimalista (top da semana)", section: "ranking", room: "quarto",   kind: "decorated", style: "minimalista" },
  { id: "rank-bathroom",        src: decoratedBathroom,  alt: "Banheiro travertino (top da semana)",section: "ranking", room: "banheiro", kind: "decorated", style: "luxo" },
  { id: "rank-kitchen",         src: decoratedKitchen,   alt: "Cozinha luxo discreto (top da semana)",section: "ranking", room: "cozinha", kind: "decorated", style: "luxo" },
];
