...
const SHOPPING_LIST_COZINHA: ReadonlyArray<BudgetItem> = [
  { tag: "Essencial",   name: "Armário de cozinha modulado", cat: "Móveis principais", price: "R$ 1.500–6.000" },
  { tag: "Essencial",   name: "Mesa de jantar 4 lugares",    cat: "Móveis principais", price: "R$ 600–2.200" },
  { tag: "Essencial",   name: "Cadeiras de jantar (4)",      cat: "Móveis principais", price: "R$ 480–1.600" },
  ...
  { tag: "Opcional",    name: "Conjunto de potes herméticos", cat: "Organização",      price: "R$ 100–380" },
...
const SHOPPING_LIST_HOME_OFFICE: ReadonlyArray<BudgetItem> = [
  { tag: "Essencial",   name: "Escrivaninha de trabalho",  cat: "Móveis principais", price: "R$ 350–1.500" },
...
const SHOPPING_LIST_BANHEIRO: ReadonlyArray<BudgetItem> = [
  { tag: "Essencial",   name: "Gabinete de banheiro",      cat: "Móveis principais", price: "R$ 400–1.800" },
