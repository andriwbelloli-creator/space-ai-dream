  ...
  if (mark) {
    return (
      <svg viewBox="0 0 40 40" className={className} aria-label="Ideal Space">
        ...
        />
        <path
          d="M13 27V14h2v13h-2zm6 0V14h7c2.8 0 4.8 1.7 4.8 4.1 0 1.8-1 3.1-2.6 3.6 1.8.4 2.9 1.7 2.9 3.7 0 2.6-2 4.3-5.1 4.3H19zm2-7.6h4.6c1.6 0 2.6-.9 2.6-2.3s-1-2.3-2.6-2.3H21v4.6zm0 6h5c1.7 0 2.8-1 2.8-2.5s-1.1-2.4-2.8-2.4H21V25.4z"
          fill="currentColor"
        />
